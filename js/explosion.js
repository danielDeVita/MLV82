...
export class Explosion {
  constructor(game, x, y, type = "air") {
    ...
    const baseRadius =
      type === "ground" ? 40 : type === "ship" ? 50 : type === "tiny" ? 10 : 30;
    ...
    if (type === "ground") {
      /* Brownish */ this.outerColor = "rgba(139, 69, 19, 0.6)";
      this.innerColor = "rgba(255, 165, 0, 0.8)";
    } else if (type === "ship") {
      /* Redder */ this.outerColor = "rgba(255, 0, 0, 0.6)";
      this.innerColor = "rgba(255, 100, 100, 0.8)";
    } else if (type === "tiny") {
      /* Grey/White */ this.outerColor = "rgba(200, 200, 200, 0.5)";
      this.innerColor = "rgba(255, 255, 255, 0.7)";
    }
