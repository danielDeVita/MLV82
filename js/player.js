...
export class Player {
    ...
    reset() {
        ...
        this.lives = 3; // Reset to base lives
        this.bulletPowerUpActive = false; this.bulletPowerUpTimer = 0;
        this.bombPowerUpActive = false; this.bombPowerUpTimer = 0;
        this.spreadShotActive = false; this.spreadShotTimer = 0;
        this.shieldActive = false; this.shieldTimer = 0;
        this.invincible = false; this.invincibilityTimer = 0;
        this.lastBombTime = 0; this.lastShotTime = 0;
